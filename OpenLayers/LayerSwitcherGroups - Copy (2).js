  ...
  OpenLayers.Class(OpenLayers.Control.LayerSwitcher, {
    ...
    redraw: function() {
        ...
        function addGroupHeader(group, layers) {
            ...
            toggleElem.innerHTML = layers.hide ? "<img src=\"img/them.gif\">" : "<img src=\"img/bot.gif\">";
            ...
            function hideClick() {
                if (this.toggleElem.innerHTML == "<img src=\"img/them.gif\">") { 
                    layers.hide = false; 
                    this.toggleElem.innerHTML = "<img src=\"img/bot.gif\">";
                } else {
                    layers.hide = true;
                    this.toggleElem.innerHTML = "<img src=\"img/them.gif\">";
                }
